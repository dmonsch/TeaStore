...
public class OrderItem {
	...
	/**
	 * Get the id (remember that this ID may be incorrect, especially if a separate
	 * id was passed).
	 * 
	 * @return The id.
	 */
	...
	/**
	 * Sets the ID of the order item's product. Every order Item MUST have a valid
	 * product ID.
	 * 
	...
	/**
	 * Sets the ID of the order item's order. Persistence requires that every order
	 * item MUST have a valid order ID. For persistence the order must already exist
	 * in database.
	 * 
