...
public class Order {
	...
	/**
	 * Get the time of order (ISO formatted). Formatted using
	...
	/**
	 * Set the time of order (ISO formatted). Format using
	 * {@link DateTimeFormatter.ISO_LOCAL_DATE_TIME}.
	 * 
	...
	/**
	 * Get the credit card expiry date (ISO formatted). Formatted using
	...
	/**
	 * Set the credit card expiry date (ISO formatted). Format using
	 * {@link DateTimeFormatter.ISO_LOCAL_DATE}.
	 * 
